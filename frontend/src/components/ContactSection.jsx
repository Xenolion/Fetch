        ...
        <div id="about" className="mt-20 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg text-gray-600 leading-relaxed mb-8">
              ...
              Whether you're organizing a wedding, birthday party, corporate event, or group trip, our app ensures transparency, 
              security, and ease of use for all participants.
            </p>
